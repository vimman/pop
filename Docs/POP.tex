	...
	\vspace{5em}
			...
			\center{
				...
				\begin{tabular}{|c|c|c|c|c|c|}\hline
					...
					Screen Connector &
					\href{http://fr.farnell.com/hirose-hrs/fh12-24s-0-5sh-55/fiche-femelle-ffc-fpc-0-5mm-zif/dp/1324552}
					{FH12-24S-0.5SH(55)} & 0.714 & &
					- &
					\href{http://www.farnell.com/datasheets/2043906.pdf}{\includegraphics[height=1em]{pdf.png}}\\
